...
public class ChessPiece extends JLabel {
    ...
    public static final int PIECEWIDTH = 56;
    private Part part;
...
//    ChessBoard board = null;
    ...
    public ChessPiece(Place place, Part part, Icon icon) {
        this.setSize(PIECEWIDTH, PIECEWIDTH);
        this.setIcon(icon);
        setLocation(place.x * PIECEWIDTH, place.y * PIECEWIDTH);
        this.part = part;
    }
